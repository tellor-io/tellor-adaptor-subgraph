...
export class ContractMint extends ethereum.Event {
  get params(): ContractMint__Params {
    return new ContractMint__Params(this);
  }
}

export class ContractMint__Params {
  _event: ContractMint;

  constructor(event: ContractMint) {
    this._event = event;
  }
...
export class Contract__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  getAccountSnapshot(account: Address): Contract__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new Contract__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<Contract__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
